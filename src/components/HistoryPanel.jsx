...
export default function HistoryPanel({ open, onClose, history, krwRate, onExpand, onDownload, onDelete, onClear, onReuse, onUseAsReference, onMaskEdit, onSendToBoard }) {
  if (!open) return null
  return (
    <div
      onClick={onClose}
                ...
                <div key={item.id} style={{ display: 'flex', gap: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 4 }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: 'auto' }}>
                      ...
                      <HistoryAction label="🎨 보드로" onClick={() => onSendToBoard(item)} />
